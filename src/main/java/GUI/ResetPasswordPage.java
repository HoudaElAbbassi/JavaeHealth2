...
public class ResetPasswordPage extends JFrame{
     ...
     * The new password gets generated by the class GeneratePassword. After sending the Mail this Page closes and
     * @Exception EmailException is thrown when an error occurs by sending an email
